		...
		if (type instanceof org.eclipse.emf.ecore.EDataType) {
			...
			if (Boolean.TYPE.equals(iClass)) {
				if (value instanceof Boolean) {
					...
					value = new InvalidValue(org.eclipse.osgi.util.NLS.bind(linuxnetconf.diagram.part.Messages.AbstractParser_UnexpectedValueType, iClass.getName()));
				}
				...
				if (value instanceof Byte) {
					...
					if (s.length() == 0) {
						...
						try {
							...
							value = new InvalidValue(org.eclipse.osgi.util.NLS.bind(linuxnetconf.diagram.part.Messages.AbstractParser_WrongStringConversion, iClass.getName()));
						}
					}
				} else {
					value = new InvalidValue(org.eclipse.osgi.util.NLS.bind(linuxnetconf.diagram.part.Messages.AbstractParser_UnexpectedValueType, iClass.getName()));
				...
				if (value instanceof String) {
					...
					if (literal == null) {
						value = new InvalidValue(org.eclipse.osgi.util.NLS.bind(linuxnetconf.diagram.part.Messages.AbstractParser_UnknownLiteral, value));
					} else {
						value = literal.getInstance();
					}
				} else {
					value = new InvalidValue(org.eclipse.osgi.util.NLS.bind(linuxnetconf.diagram.part.Messages.AbstractParser_UnexpectedValueType, String.class.getName()));
				}
			}
		}
		return value;
