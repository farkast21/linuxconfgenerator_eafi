...
import linuxnetconf.diagram.edit.policies.EthernetInterfaceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EthernetInterfaceEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public EthernetInterfaceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EthernetInterfaceItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EthernetInterfaceFigure();
	}

	/**
	 * @generated
	 */
	public EthernetInterfaceFigure getPrimaryShape() {
		return (EthernetInterfaceFigure) primaryShape;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == LinuxnetconfElementTypes.VlanOwnerVlans_4003) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		} else if (relationshipType == LinuxnetconfElementTypes.BridgeBridgePorts_4002) {
	 ...
	 * @generated
	 */
	public class EthernetInterfaceFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		public EthernetInterfaceFigure() {
		...
		private void createContents() {
			...
			fFigureEthernetInterfaceConfigTypeFigure = new WrappingLabel();
			fFigureEthernetInterfaceConfigTypeFigure.setText("<...>");

			this.add(fFigureEthernetInterfaceConfigTypeFigure);
