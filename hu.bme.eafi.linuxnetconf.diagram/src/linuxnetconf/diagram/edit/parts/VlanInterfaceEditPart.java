...
import linuxnetconf.diagram.edit.policies.VlanInterfaceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class VlanInterfaceEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public VlanInterfaceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new VlanInterfaceItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new VlanInterfaceFigure();
	}

	/**
	 * @generated
	 */
	public VlanInterfaceFigure getPrimaryShape() {
		return (VlanInterfaceFigure) primaryShape;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == LinuxnetconfElementTypes.InterfaceSubinterfaces_4004) {
	 ...
	 * @generated
	 */
	public class VlanInterfaceFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureVlanInterfaceConfigTypeFigure = new WrappingLabel();
			fFigureVlanInterfaceConfigTypeFigure.setText("<...>");

			this.add(fFigureVlanInterfaceConfigTypeFigure);
