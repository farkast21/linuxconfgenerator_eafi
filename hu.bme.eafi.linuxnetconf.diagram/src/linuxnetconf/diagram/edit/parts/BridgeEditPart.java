...
import linuxnetconf.diagram.edit.policies.BridgeItemSemanticEditPolicy;
...
public class BridgeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BridgeItemSemanticEditPolicy());
	 ...
	 * @generated
	 */
	public class BridgeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureBridgeConfigTypeFigure = new WrappingLabel();
			fFigureBridgeConfigTypeFigure.setText("<...>");

			this.add(fFigureBridgeConfigTypeFigure);
