 ...
 * @generated
 */
public class InterfaceSubinterfacesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InterfaceSubinterfacesCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof SubInterface) {
			return false;
		}
		if (getSource() == null) {
		...
		return LinuxnetconfBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateInterfaceSubinterfaces_4004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSubinterfaces().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected SubInterface getTarget() {
		return (SubInterface) target;
	}
}
