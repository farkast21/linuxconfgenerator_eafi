 ...
 * @generated
 */
public class BridgeBridgePortsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BridgeBridgePortsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Bridge) {
			return false;
		}
		...
		return LinuxnetconfBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateBridgeBridgePorts_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getBridgePorts().add(getTarget());
		}
