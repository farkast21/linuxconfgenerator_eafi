...
import linuxnetconf.diagram.edit.commands.BondingInterfaceSlavesCreateCommand;
import linuxnetconf.diagram.edit.commands.BondingInterfaceSlavesReorientCommand;
 ...
 * @generated
 */
public class EthernetInterfaceItemSemanticEditPolicy extends
		LinuxnetconfBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public EthernetInterfaceItemSemanticEditPolicy() {
		super(LinuxnetconfElementTypes.EthernetInterface_2003);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (LinuxnetconfVisualIDRegistry.getVisualID(incomingLink) == BondingInterfaceSlavesEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (LinuxnetconfVisualIDRegistry.getVisualID(outgoingLink) == VlanOwnerVlansEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (LinuxnetconfElementTypes.BondingInterfaceSlaves_4001 == req
				.getElementType()) {
			return null;
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (LinuxnetconfElementTypes.BondingInterfaceSlaves_4001 == req
				.getElementType()) {
			return getGEFWrapper(new BondingInterfaceSlavesCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
		if (LinuxnetconfElementTypes.BridgeBridgePorts_4002 == req
				.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case BondingInterfaceSlavesEditPart.VISUAL_ID:
			return getGEFWrapper(new BondingInterfaceSlavesReorientCommand(req));
