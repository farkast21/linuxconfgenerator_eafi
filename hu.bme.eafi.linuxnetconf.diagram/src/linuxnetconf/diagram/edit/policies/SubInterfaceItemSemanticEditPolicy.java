 ...
 * @generated
 */
public class SubInterfaceItemSemanticEditPolicy extends
		LinuxnetconfBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SubInterfaceItemSemanticEditPolicy() {
		super(LinuxnetconfElementTypes.SubInterface_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (LinuxnetconfVisualIDRegistry.getVisualID(incomingLink) == InterfaceSubinterfacesEditPart.VISUAL_ID) {
