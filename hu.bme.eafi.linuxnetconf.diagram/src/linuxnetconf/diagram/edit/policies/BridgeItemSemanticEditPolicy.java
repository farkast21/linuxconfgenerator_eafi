 ...
 * @generated
 */
public class BridgeItemSemanticEditPolicy extends
	...
	public BridgeItemSemanticEditPolicy() {
		super(LinuxnetconfElementTypes.Bridge_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (LinuxnetconfVisualIDRegistry.getVisualID(outgoingLink) == BridgeBridgePortsEditPart.VISUAL_ID) {
