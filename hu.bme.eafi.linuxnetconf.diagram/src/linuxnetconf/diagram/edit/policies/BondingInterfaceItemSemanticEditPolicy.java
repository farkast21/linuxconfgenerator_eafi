 ...
 * @generated
 */
public class BondingInterfaceItemSemanticEditPolicy extends
		LinuxnetconfBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public BondingInterfaceItemSemanticEditPolicy() {
		super(LinuxnetconfElementTypes.BondingInterface_2005);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (LinuxnetconfVisualIDRegistry.getVisualID(outgoingLink) == BondingInterfaceSlavesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
