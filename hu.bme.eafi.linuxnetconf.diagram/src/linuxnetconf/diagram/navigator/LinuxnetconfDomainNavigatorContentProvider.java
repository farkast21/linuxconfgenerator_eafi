 ...
 * @generated
 */
public class LinuxnetconfDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public LinuxnetconfDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof LinuxnetconfDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((LinuxnetconfDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new LinuxnetconfDomainNavigatorItem(
