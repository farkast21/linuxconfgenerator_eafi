...
/**
 * This is the item provider adapter for a {@link linuxnetconf.ServerComputer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServerComputerItemProvider
	 ...
	 * @generated
	 */
	public ServerComputerItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServerComputer_group_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServerComputer_group_feature", "_UI_ServerComputer_type"),
				 LinuxnetconfPackage.Literals.SERVER_COMPUTER__GROUP,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ServerComputer.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ServerComputer"));
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(LinuxnetconfPackage.Literals.SERVER_COMPUTER__CONFITEMS,
				 LinuxnetconfFactory.eINSTANCE.createEthernetInterface()));

		newChildDescriptors.add
			(createChildParameter
				(LinuxnetconfPackage.Literals.SERVER_COMPUTER__CONFITEMS,
				 LinuxnetconfFactory.eINSTANCE.createBondingInterface()));

		newChildDescriptors.add
			(createChildParameter
				(LinuxnetconfPackage.Literals.SERVER_COMPUTER__CONFITEMS,
				 LinuxnetconfFactory.eINSTANCE.createVlanInterface()));

		newChildDescriptors.add
			(createChildParameter
				(LinuxnetconfPackage.Literals.SERVER_COMPUTER__CONFITEMS,
				 LinuxnetconfFactory.eINSTANCE.createBridge()));
