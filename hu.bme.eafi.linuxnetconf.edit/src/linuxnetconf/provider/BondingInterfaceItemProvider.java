...
public class BondingInterfaceItemProvider
	 ...
	 * @generated
	 */
	public BondingInterfaceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BondingInterface_slaves_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BondingInterface_slaves_feature", "_UI_BondingInterface_type"),
				 LinuxnetconfPackage.Literals.BONDING_INTERFACE__SLAVES,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BondingInterface"));
	}
